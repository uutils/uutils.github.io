...
<div class="playground-examples">
  ...
  <button class="playground-example">grep chèvre fromages.txt | cut -d, -f1 | sort</button>
  <button class="playground-example">grep -v vache fromages.txt | sed -e 's/brebis/🐑/' -e 's/chèvre/🐐/' | cut -d, -f1,3 | sort -t, -k2</button>
